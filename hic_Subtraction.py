...
def get_Subtraction(c1,c2,area_s,area_e):
    ...
    arr1 = (mat1/mat1.sum())*100000
    arr2 = (mat2/mat2.sum())*100000
    arr_sub = arr1-arr2
...
def get_fig(data,area_s,area_e,outdir,outfig):
    ...
    im = ax.matshow(data,cmap='seismic',vmin=-1, vmax=1,interpolation='none') ## vmin vmax determin the range of colorbar
